...
function Viewcontest() {
    ...
    const fetchData = async () => {
        try {
          ...
          console.log(token)
          const response = await fetch(`${BASE_URL}/api/contest/displayDetails?contestId=${_id}`, {
            method: "GET",
            headers: {
              Authorization: token,
            },
    ...
    <Card sx={{ maxWidth: 200 }}>
      ...
      <CardContent>
        <ProfileInfoCard
                        ...
                        info={{
                          "Contest-type":display?.contestTypeData
                          ?.[0]?.contest_type,
                          ...
                          "league Name":display?.leagueData?.[0]?.league_name,
